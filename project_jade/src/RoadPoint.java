...
public class RoadPoint {
	...
	public RoadPoint() {
		...
		TrafficCenterList = Arrays.asList(
				...
				new TrafficCenter(new Point(282, 181), 2)
				);
		
		SignalLocList = Arrays.asList(new SignalLoc(new Point(305, 600),new Point(305, 518), 1),
				new SignalLoc(new Point(0, 475),new Point(219, 475), 1),
				new SignalLoc(new Point(260, 220),new Point(260, 388), 1),
				
				new SignalLoc(new Point(260, 0),new Point(260, 116), 2),
				new SignalLoc(new Point(600, 158),new Point(349, 158), 2),
				new SignalLoc(new Point(305, 400),new Point(305, 246), 2)
				
				);
		

		startLocInfoList = Arrays.asList(new Point(260, 0), new Point(0, 475), new Point(305, 600), new Point(600, 158));
